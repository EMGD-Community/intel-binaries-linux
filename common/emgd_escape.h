...
#define INTEL_ESCAPE_ERROR_VEXT_OOO  2
...
#define INTEL_ESCAPE_GET_SUBPICT_ON_FB       0x20032
#define INTEL_ESCAPE_SET_WAIT_ON_2DCOPY_BLT	0x20033
...
static __inline char *intel_esc_str(unsigned int esc)
{
	...
	case INTEL_ESCAPE_SET_WAIT_ON_2DCOPY_BLT:
		return "INTEL_ESCAPE_SET_WAIT_ON_2DCOPY_BLT";
	default:
...
#define EGD_OVERLAY_COLORKEY_RGB_MASK		0xffffff
...
typedef struct _iegd_esc_set_wait_on_2dcopy_blt {
	unsigned int wait_on_2dcopy_blt_enable;
} iegd_esc_set_wait_on_2dcopy_blt_t;
